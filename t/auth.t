...
for my $module(qw/t::lib::AuthSQLite t::lib::AuthMySQL/) {
    note "Testing $module ...";
    ...
    test_psgi $jedi->start, sub {
        ...
        subtest "purge" => sub {
            my $res = $cb->(GET '/purge');
            is $res->code, 204, 'purge ok' or diag $res->content;
        };
        ...
        subtest "signin" => sub {
            ...
            subtest "signin again user" => sub 
            {
                ...
                like $resp->{error_msg}, qr{\Quser is not uniq\E|Duplicate}, 'user already exists';
            };
